...
Original file is located at
    https://colab.research.google.com/drive/1hAV4FWWbyDvzMSPI6JdpOn9HWHKEfubO
"""
...
trymodel.save(model_directory+"VGG19_my_model_1.h5")
...
def try_model_v2():
    base_model_v2 = VGG19(weights='imagenet', include_top=False, input_shape=(224, 224, 3))
...
trymodel_v2.save(model_directory+"VGG19_my_model_2.h5")
...
def try_model_v3():
    base_model_v3 = VGG19(weights='imagenet', include_top=False, input_shape=(224, 224, 3))
...
trymodel_v3.save(model_directory+"VGG19_my_model_3.h5")
...
model_name_1 = "VGG19 with 50 percent layers"
model_name_2 = "VGG19 with 60 percent layer"
model_name_3 = "VGG19 with 70 percent layer"
...
metrics_df.to_csv('/content/drive/MyDrive/ Breastcancer_Project1/working/VGG19_model_metrics.csv', index=False)
...
model  = load_model('/content/drive/MyDrive/ Breastcancer_Project1/working/save_model/VGG19_my_model_1.h5')
...
# Load your trained model
model = load_model('/content/drive/MyDrive/ Breastcancer_Project1/working/save_model/VGG19_my_model_3.h5')
last_conv_layer_name = "conv5_block3_out"  # Replace with your model's last conv layer
